...
from src.caption.caption_ms import UniterTwoForCaptionWithLoss
...
def main(opts):
    ...
    net_with_loss = UniterTwoForCaptionWithLoss(opts.model_config, opts)
    ...
    if rank_id == 0:
        ...
        ckpoint_cb = ModelCheckpoint(prefix="OPT-CAP",
                                     directory=ckpt_dir,
                                     config=config_ck)
