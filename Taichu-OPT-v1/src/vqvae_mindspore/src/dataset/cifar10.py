...
def create_dataset_cifar10(data_path, img_size, batch_size, buffer_size, repeat_size, ifdist):
    """
    ...
    cifar_ds = cifar_ds.map(input_columns="image", operations=transforms)
