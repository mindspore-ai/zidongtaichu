...
from src.helper import parse_with_config
from src.lr_generator import LearningRate
from src.monitor import LossMonitor, UploadCheckpoint
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--config', default="/home/work/user-job-dir/mae_mindspore/config/maevit-base-p16.yaml", help='YAML config files')
