...
from src.data.data_three import TxtImgTwoDataset, get_ids_three
...
class ItmFlickrRankDataset(TxtImgTwoDataset):
    """
    ...
    def _collect_inputs(self, id_pairs):
        ...
        for txt_id, img_id in id_pairs:
            ...
            inputs.append((input_ids, img_feat, img_pos_feat, attn_masks, image))
...
def itm_rank_collate(inputs):
    ...
    itm_rank_collate
    """
    (input_ids, img_feats, img_pos_feats, attn_masks, images
