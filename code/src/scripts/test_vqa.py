...
import sys
sys.path.append('')
from tools.aic_caption.pycxevalcap import COCOEvalCap
from src.tools.aic_caption.pycxtools.coco import COCO
from data import get_batch_data_vqa_eval
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ckpt_file', default="OPT_vqa-10_11093.ckpt", type=str, help="ckpt file name")
