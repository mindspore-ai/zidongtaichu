...
def pad_attention_mask(input_ids, img_feat, audio_feat, max_lens=config.MAX_DEFAULT_LEN):
    """pad_attention_mask"""
    txt_len = input_ids[-1]
    img_len = img_feat[1]
...
def pad_sequence_(sequences, batch_first=False, padding_value=0.0, max_lens=config.MAX_DEFAULT_LEN):
    """pad_sequence"""
