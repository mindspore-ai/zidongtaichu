...
class UniterThreeForPretrainingForCapFinetune(nn.Cell):
    ...
    def __init__(self, config, img_dim, audio_dim,
        ...
        self.txt_output = TransformerModel(self.txt_cfg, True, config.hidden_size, parallel_config, fg_backbone, use_moe)
...
class UniterThreeForPretrainingForCapFinetuneEval(nn.Cell):
    ...
    def __init__(self, config, img_dim, audio_dim,
        ...
        self.txt_output = TransformerModel(txt_cfg, False, config.hidden_size, parallel_config, fg_backbone, use_moe)
    ...
    def construct(self, img_feat, img_pos_feat, attention_mask, gather_index):
        ...
        txt_output = self.generate_text_eval(sequence_output, attention_mask)
        return txt_output
